    ...
    public class JotunnShot : DestinyModProjectile
    {
        ...
        public override void AI()
        {
            ...
            else if (!player.channel && Charge < 80f)
            {
                ...
                if (!Fired)
                {
                    SoundEngine.PlaySound(new SoundStyle("DestinyMod/Assets/Sounds/Item/Weapons/Magic/JotunnCharge" + chargeMagnitude), Projectile.Center);
                }
                Fired = true;
                Projectile.netUpdate = true;
            ...
            else if (Charge >= 80f)
            {
                if (!Fired)
                {
                    SoundEngine.PlaySound(new SoundStyle("DestinyMod/Assets/Sounds/Item/Weapons/Magic/JotunnCharge5"), Projectile.Center);
                }
                Fired = true;
                Projectile.netUpdate = true;
