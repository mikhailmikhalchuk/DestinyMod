	...
	public class Zavala : ModNPC
	{
		...
		public override string GetChat() {
			if (TheDestinyMod.guardianWinner == 1 && !hasClosedCeremony) {
				...
				DestinyWorld.claimedItemsGG = hasClosedCeremony = true;
				return "Through a fierce competition and defying all odds, the Hunters have stealthily taken the win in this year's Guardian Games. Make no mistake; the determination of the Warlocks was admirable, and us Titans will achieve victory next year. To commemorate, here is some Hunter-themed decor. Stay strong, Guardian.";
			}
				...
				DestinyWorld.claimedItemsGG = hasClosedCeremony = true;
				return "Through a fierce competition and defying all odds, the Warlocks have outsmarted every other class in this year's Guardian Games. Make no mistake; the determination of the Hunters was admirable, and us Titans will achieve victory next year. To commemorate, here is some Warlock-themed decor. Stay strong, Guardian.";
			}
