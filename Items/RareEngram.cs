...
{
	public class RareEngram : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.AddTranslation(GameCulture.Polish, "Rzadki Engram");
        ...
        public override void PostUpdate() {
            Lighting.AddLight(item.Center, Color.LightBlue.ToVector3() * 0.55f * Main.essScale);
        }
